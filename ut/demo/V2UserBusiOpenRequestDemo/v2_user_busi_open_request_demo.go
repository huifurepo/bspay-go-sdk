...
func V2UserBusiOpenRequestDemo() {
    ...
    dgReq := BsPaySdk.V2UserBusiOpenRequest{
        ...
        // 乐接活配置当合作平台为乐接活，必填
        // LjhData:getB944735a6b0341329d4aA759a164a488(),
    }
    // 设置非必填字段
...
func getC7120ce19aa342479389Bae9d01d1aa1() string {
...
func get2bbcc0dd9d6e4cce97b5170aad708567() string {
    dto := make(map[string]interface{})
    // 卡类型
    dto["card_type"] = "0"
...
func get2785c9d9Cd9942b49329851add999d12() string {
    dto := make(map[string]interface{})
...
func get318a3a9787d94d619b2573150ed022f8() string {
    dto := make(map[string]interface{})
    // 文件类型
    dto["file_type"] = "F02"
    // 文件jfileID
...
func get9694530aC0c34ea58db670b01c93b29d() interface{} {
    dto := make(map[string]interface{})
    // 银行所在省
    // dto["prov_id"] = "test"
    // 银行所在市
...
func get00cc44daA41c4df7B4477828c103bffc() string {
    dto := make(map[string]interface{})
    // 电子账户开关
...
func getB944735a6b0341329d4aA759a164a488() string {
    dto := make(map[string]interface{})
    // 税源地id当合作平台为乐接活，必填
