...
func V2MerchantDirectZftRegRequestDemo() {
    ...
    dgReq := BsPaySdk.V2MerchantDirectZftRegRequest{
        ...
        ZftCardInfoList:get0086fad238754ed3B04c0ffb7d8ce54e(),
        ...
        // 文件列表
        FileList:getA2582375Fa7747589f63B935d5a58216(),
    }
    // 设置非必填字段
...
func get0086fad238754ed3B04c0ffb7d8ce54e() string {
...
func get75d5b1e84abd448b919eF4973ee262a0() string {
    dto := make(map[string]interface{})
    // 站点类型
    dto["site_type"] = "02"
    // 站点地址
...
func getA2582375Fa7747589f63B935d5a58216() string {
    dto := make(map[string]interface{})
    // 文件类型
    dto["file_type"] = "F41"
    // 文件ID
