 ...
 * @Description 汇付天下
 */
package V3TradePaymentScanpayQueryRequestDemo
...
func V3TradePaymentScanpayQueryRequestDemo() {
    // 1. 数据初始化
	dgSDK, _ := BsPaySdk.NewBsPay(true, "./config/config.json")

    // 2.组装请求参数
    dgReq := BsPaySdk.V3TradePaymentScanpayQueryRequest{
        // 汇付商户号
    ...
    // 3. 发起API调用
    resp, err := dgSDK.V3TradePaymentScanpayQueryRequest(dgReq)
  	if err != nil {
