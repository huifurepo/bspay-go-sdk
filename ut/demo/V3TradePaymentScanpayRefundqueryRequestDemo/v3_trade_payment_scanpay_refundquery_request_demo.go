 ...
 * @Description 汇付天下
 */
package V3TradePaymentScanpayRefundqueryRequestDemo
...
func V3TradePaymentScanpayRefundqueryRequestDemo() {
    // 1. 数据初始化
	dgSDK, _ := BsPaySdk.NewBsPay(true, "./config/config.json")

    // 2.组装请求参数
    dgReq := BsPaySdk.V3TradePaymentScanpayRefundqueryRequest{
        // 商户号
    ...
    // 3. 发起API调用
    resp, err := dgSDK.V3TradePaymentScanpayRefundqueryRequest(dgReq)
  	if err != nil {
