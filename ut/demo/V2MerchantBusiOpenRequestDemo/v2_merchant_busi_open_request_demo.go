...
func V2MerchantBusiOpenRequestDemo() {
    ...
    dgReq := BsPaySdk.V2MerchantBusiOpenRequest{
        ...
        // SignUserInfo:getB6e83d7eC97c4d1982e788a8308c91db(),
        ...
        AgreementInfo:get93e686fd95714354A54e604dc5866944(),
    }
    // 设置非必填字段
...
func getB6e83d7eC97c4d1982e788a8308c91db() string {
...
func get789d563b964949268241B422fc5bb2c9() string {
    dto := make(map[string]interface{})
    // 联系人身份证号码
...
func getF3568ac04ad9448eA6d081ab506bd253() string {
    dto := make(map[string]interface{})
    // 证件持有人类型
    // dto["legal_type"] = ""
    // 证件类型
...
func get63f800eaFb2e4faaA45762790aebeca7() interface{} {
    dto := make(map[string]interface{})
    // 是否金融机构
...
func getB1b1b5c47b604a7490bfCcf556ac2733() string {
    dto := make(map[string]interface{})
    // 支付场景
    dto["pay_scene"] = "1"
    // 手续费（%）
...
func get44f2f366E715491bA601775f1787f5a4() interface{} {
    dto := make(map[string]interface{})
    // 文件类型
    // dto["file_type"] = "test"
    // 文件jfileId
...
func get8ce399cbC08346ea93d4Ce3814ca5e71() string {
    dto := make(map[string]interface{})
    // 申请类型
    // dto["apply_type"] = "test"
    // 商户支付宝账号
...
func get8f318ab9063d4c54B923208f87cb6a6c() interface{} {
    dto := make(map[string]interface{})
...
func getB669fddf34ab454785f46e4140e5e43b() string {
    dto := make(map[string]interface{})
    // 支付场景
    dto["pay_scene"] = "1"
    // 手续费（%）
...
func get85d5b676191e40b48133Ec2501d25ec0() interface{} {
    dto := make(map[string]interface{})
    // 文件类型
    // dto["file_type"] = "test"
    // 文件jfileId
...
func get20d5ee921e3b4b10A536C4d1e553b7e8() interface{} {
    dto := make(map[string]interface{})
    // 联系人类型
...
func get3ed2ef30E5644c5bAef478b32ebb7d9f() interface{} {
    dto := make(map[string]interface{})
    // 文件类型
    // dto["file_type"] = "test"
    // 文件jfileId
...
func get9d3e09743c864ac5B668F59bbfe5099a() interface{} {
    dto := make(map[string]interface{})
    // 证件类型
...
func get8eac07e487864bd6B312E75392c394be() interface{} {
    dto := make(map[string]interface{})
    // 经营者/法人是否为受益人
    // dto["ubo_type"] = "test"
...
func get89854fb3A0e54cfa8805C45cb510e04a() interface{} {
    dto := make(map[string]interface{})
    // 文件类型
    // dto["file_type"] = "test"
    // 文件jfileId
...
func getBa04b5fbAe6d4216A21f9a58a6fa9ccd() interface{} {
    dto := make(map[string]interface{})
    // 经营场景类型
...
func getCafdf5740ad44b5782f34c42fdc0c55d() interface{} {
    dto := make(map[string]interface{})
    // 文件类型
    // dto["file_type"] = "test"
    // 文件jfileId
...
func getBeb331e634e6480189c805aadc9b5ba5() interface{} {
    dto := make(map[string]interface{})
    // 登记证书类型
    // dto["cert_type"] = "test"
    // 证书号
...
func get4cf6ea0b3abb434cA138A2f3eaeed6df() interface{} {
    dto := make(map[string]interface{})
    // 账户类型
    // dto["card_type"] = "test"
    // 开户名称
...
func get7c924e80101a4d528127021b85eb9fc5() interface{} {
    dto := make(map[string]interface{})
    // 申请服务
...
func get42fb9ef288234eecA3e1Ba2f00416263() interface{} {
    dto := make(map[string]interface{})
    // 文件类型
    // dto["file_type"] = "test"
    // 文件jfileId
...
func getF4fac2e53a2c4fc99ce0278158ac7be6() string {
    dto := make(map[string]interface{})
...
func getCacad185A3844234Bc21D7a8baf09862() string {
    dto := make(map[string]interface{})
    // 借记卡手续费（%）
...
func get4df6e0eaE26840f892037584595fc520() string {
    dto := make(map[string]interface{})
    // 借记卡手续费（%）
...
func get4fb88483Fe354325Bd559423cac50a59() string {
    dto := make(map[string]interface{})
    // 业务类型
    // dto["fee_type"] = "test"
...
func get1a7db6ad675243239f5dE15e55094de4() string {
    dto := make(map[string]interface{})
    // 业务类型
    // dto["pay_type"] = ""
    // 手续费外扣时的账户类型
...
func get99349170B4204adcB5e8Da99d620c754() string {
    dto := make(map[string]interface{})
    // *运营媒介类型*
    // dto["media_type"] = "test"
...
func get3dfe0dd9790740cdA3483476077f73df() interface{} {
    dto := make(map[string]interface{})
...
func get8198464b9d5a40e69f9dB6ac7726d573() string {
    dto := make(map[string]interface{})
    // *业务模式*
...
func get15cec1475e894cb495beE1fdbc7486f2() interface{} {
    dto := make(map[string]interface{})
...
func get7baacf6e8a3f45b5A073Ccaa5742140c() interface{} {
    dto := make(map[string]interface{})
    // 开户手续费(元)
...
func getDb2aad74070146479fea120f7167811c() string {
    dto := make(map[string]interface{})
    // 自动入账开关
...
func get5dc2e3d49bac46e49c400d0dba3c91f0() string {
    dto := make(map[string]interface{})
    // 是否交易手续费外扣
...
func get6125bb8dBea14eaaB3feAdc5a328317e() string {
    dto := make(map[string]interface{})
...
func get6c7a364aC1e64d9a82822c3e24f59253() string {
    dto := make(map[string]interface{})
    // 归集留存金(元)
...
func get91eac6c511a44a3dA9153acc3b9fd7f7() interface{} {
    dto := make(map[string]interface{})
    // 分账比例
    // dto["fee_rate"] = "test"
    // 汇付Id
...
func get5da774e3E7454c9dB0a355a1d51eba60() interface{} {
    dto := make(map[string]interface{})
    // *业务模式说明*
    // dto["busi_instruction"] = "test"
    // *资金流向说明*
...
func get691c39ac13fd4276A8ae1b50edc0fd0a() string {
    dto := make(map[string]interface{})
    // 分账开关
    // dto["div_flag"] = "test"
    // 分账规则来源
...
func get5b46783388754f0fAb86178e136e8186() string {
    dto := make(map[string]interface{})
    // *文件id*
    // dto["file_id"] = "test"
    // *文件类型*
...
func get93e686fd95714354A54e604dc5866944() string {
    dto := make(map[string]interface{})
    // *协议类型*
...
func get817fd026C9764e389a4eDea12ebd9fe8() string {
    dto := make(map[string]interface{})
...
func get7bce094eC54947caA664C0303f211848() string {
    dto := make(map[string]interface{})
    // 代发业务类型
...
func get8157920dAac14a7a94e439e75e990e47() interface{} {
    dto := make(map[string]interface{})
    // 大额支付业务模式
...
func get3eb9fd08566b44918d473a723cea37b5() string {
    dto := make(map[string]interface{})
    // 大额支付配置列表
...
func get3c520d21F4594dab8cea109be9606693() interface{} {
    dto := make(map[string]interface{})
    // 代发复核开关
...
func get436f7b4bA3484ab1Afb965042029d5fa() interface{} {
    dto := make(map[string]interface{})
    // 操作人姓名
    // dto["user_name"] = "test"
    // 操作人手机号
...
func getCe923151972f4d15A8a97d43a846a1c7() interface{} {
    dto := make(map[string]interface{})
    // 账户类型
    // dto["acct_type"] = "test"
    // 银行账户信息当账户类型为银行账户时必填
...
func get93ced9809dc34be28cd3C45f54db4745() interface{} {
    dto := make(map[string]interface{})
    // 合单支付模式
...
func get09ce87e146ac4f9dBdddAea2114bb47a() interface{} {
    dto := make(map[string]interface{})
    // 合单支付开关
