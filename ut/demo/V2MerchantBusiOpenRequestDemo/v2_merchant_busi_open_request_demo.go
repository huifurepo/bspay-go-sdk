...
func V2MerchantBusiOpenRequestDemo() {
    ...
    dgReq := BsPaySdk.V2MerchantBusiOpenRequest{
        ...
        // SignUserInfo:get4bd65fd20d65417c86786677bc8c78d2(),
        ...
        AgreementInfo:getFae873a3Ec5a42e597209188f140b998(),
    }
    // 设置非必填字段
...
func get4bd65fd20d65417c86786677bc8c78d2() string {
...
func getA21c44b148194b69Be07523fac8b17f0() string {
    dto := make(map[string]interface{})
    // 联系人身份证号码
...
func get91568db6Fc9748a7Bcc899b8bdf63abb() string {
    dto := make(map[string]interface{})
    // 证件持有人类型
    // dto["legal_type"] = ""
    // 证件类型
...
func getF80837ad47c243588541688bd99537a0() interface{} {
    dto := make(map[string]interface{})
    // 是否金融机构
...
func get44ad752cA4fa4e1388c15c9eba9059bb() string {
    dto := make(map[string]interface{})
    // 支付场景
    dto["pay_scene"] = "1"
    // 手续费（%）
...
func get29d3d02b5ccc4091Ba100ecb5e6c81fe() interface{} {
    dto := make(map[string]interface{})
    // 文件类型
    // dto["file_type"] = "test"
    // 文件jfileId
...
func getEa36a7f7405c4d5991e4Af308816da51() string {
    dto := make(map[string]interface{})
    // 申请类型
    // dto["apply_type"] = "test"
    // 商户支付宝账号
...
func get8b51663e8f454cfbBa66D1806dc9b09b() interface{} {
    dto := make(map[string]interface{})
...
func get326ddb1137ee43b98483Cf539a951637() string {
    dto := make(map[string]interface{})
    // 支付场景
    dto["pay_scene"] = "1"
    // 手续费（%）
...
func get59574734Ba5c4f1b9b10F204d87e78b7() interface{} {
    dto := make(map[string]interface{})
    // 文件类型
    // dto["file_type"] = "test"
    // 文件jfileId
...
func getFba08581E1304adb8c9dE2f5cf9754e1() interface{} {
    dto := make(map[string]interface{})
    // 联系人类型
...
func get0807adceE8fb4db487c025d3581168c0() interface{} {
    dto := make(map[string]interface{})
    // 文件类型
    // dto["file_type"] = "test"
    // 文件jfileId
...
func getA6294956340247baBff51f7197eeb61c() interface{} {
    dto := make(map[string]interface{})
    // 证件类型
...
func get8a9888cb2c874603832dDaba988d8f89() interface{} {
    dto := make(map[string]interface{})
    // 经营者/法人是否为受益人
    // dto["ubo_type"] = "test"
...
func get7878847b23e54e9c972dA390f69eecab() interface{} {
    dto := make(map[string]interface{})
    // 文件类型
    // dto["file_type"] = "test"
    // 文件jfileId
...
func get2bf45a61783f4771B9837228bda2a966() interface{} {
    dto := make(map[string]interface{})
    // 经营场景类型
...
func get58d47e934c7f49ba887a92b11643c0b6() interface{} {
    dto := make(map[string]interface{})
    // 文件类型
    // dto["file_type"] = "test"
    // 文件jfileId
...
func get7e1e9617E87b405583ba1ca6ee4694ec() interface{} {
    dto := make(map[string]interface{})
    // 登记证书类型
    // dto["cert_type"] = "test"
    // 证书号
...
func get30f5673325aa480888ffE3e049e36ef1() interface{} {
    dto := make(map[string]interface{})
    // 账户类型
    // dto["card_type"] = "test"
    // 开户名称
...
func get2942f89aAc5041e88df2Af551818a42e() interface{} {
    dto := make(map[string]interface{})
    // 申请服务
...
func get7577723c5a3e4c5fAe831269bcadbb24() interface{} {
    dto := make(map[string]interface{})
    // 文件类型
    // dto["file_type"] = "test"
    // 文件jfileId
...
func get1dd1c9cf258f4df0AffcD80e4ffd9a0b() string {
    dto := make(map[string]interface{})
...
func getE5fbb33e99de4798Bd862ead1d1f667e() string {
    dto := make(map[string]interface{})
    // 借记卡手续费（%）
...
func getCe16c6932a674b58B66261b94d44d755() string {
    dto := make(map[string]interface{})
    // 借记卡手续费（%）
...
func getDe0a92af5fb44b26Bf5201bbfe88533d() string {
    dto := make(map[string]interface{})
    // 业务类型
    // dto["fee_type"] = "test"
...
func getA0bd1574777743bc8887B46e401ce7da() string {
    dto := make(map[string]interface{})
    // 业务类型
    // dto["pay_type"] = ""
    // 手续费外扣时的账户类型
...
func getC4f584ae068447c0A0460eebef58e7e2() string {
    dto := make(map[string]interface{})
    // *运营媒介类型*
    // dto["media_type"] = "test"
...
func get89e3dcdfAf4045d68e91B95f2d39bbf4() interface{} {
    dto := make(map[string]interface{})
...
func get3822cc444afc42bd854d5a63e22beeb9() string {
    dto := make(map[string]interface{})
    // *业务模式*
...
func get88f51a47A5214d0093e579bafffee99b() interface{} {
    dto := make(map[string]interface{})
...
func get335e258f1e194550856a6efff9e8abbf() interface{} {
    dto := make(map[string]interface{})
    // 开户手续费(元)
...
func get9e84900c09a94b1084260e296ded2ead() string {
    dto := make(map[string]interface{})
    // 自动入账开关
...
func get0027e831C657442b8f9cEe80197b154d() string {
    dto := make(map[string]interface{})
    // 是否交易手续费外扣
...
func get478bea93D1cd4d559c5a3d3307974910() string {
    dto := make(map[string]interface{})
...
func get8a3d50d8E957415dA6d442117f8e2241() string {
    dto := make(map[string]interface{})
    // 归集留存金(元)
...
func getD4a604bdA6a348188210A011795c1145() interface{} {
    dto := make(map[string]interface{})
    // 分账比例
    // dto["fee_rate"] = "test"
    // 汇付Id
...
func getF0acb9057f8a4a2b926c02f4bdcafc0e() interface{} {
    dto := make(map[string]interface{})
    // *业务模式说明*
    // dto["busi_instruction"] = "test"
    // *资金流向说明*
...
func get1274c77d037f45d19e259ff64416494d() string {
    dto := make(map[string]interface{})
    // 分账开关
    // dto["div_flag"] = "test"
    // 分账规则来源
...
func get2e5e45c578f5456b8e798fc0c3bc9a3d() string {
    dto := make(map[string]interface{})
    // *文件id*
    // dto["file_id"] = "test"
    // *文件类型*
...
func getFae873a3Ec5a42e597209188f140b998() string {
    dto := make(map[string]interface{})
    // *协议类型*
...
func get9143cc3c341f470d8d8d47cbc1e3e4cd() string {
    dto := make(map[string]interface{})
...
func get4f31d14fE28a4fbaB77bD7a921f87bd4() string {
    dto := make(map[string]interface{})
    // 代发业务类型
...
func get4add493503ec40e78b65A722c7a82304() interface{} {
    dto := make(map[string]interface{})
    // 大额支付业务模式
...
func get178e63e3Cb424889A74a559118ddcb44() string {
    dto := make(map[string]interface{})
    // 大额支付配置列表
...
func getE491fc0d45244d95Bf31C06c3c478800() interface{} {
    dto := make(map[string]interface{})
    // 代发复核开关
...
func get535039d335934b49A6a7825ab29283c2() interface{} {
    dto := make(map[string]interface{})
    // 操作人姓名
    // dto["user_name"] = "test"
    // 操作人手机号
...
func get9ea440570ef8491d9d9bA6f7c3434d95() interface{} {
    dto := make(map[string]interface{})
    // 账户类型
    // dto["acct_type"] = "test"
    // 银行账户信息当账户类型为银行账户时必填
