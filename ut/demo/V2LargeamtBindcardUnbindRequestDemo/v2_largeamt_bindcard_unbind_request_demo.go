 ...
 * @Description 汇付天下
 */
package V2LargeamtBindcardUnbindRequestDemo
...
func V2LargeamtBindcardUnbindRequestDemo() {
    // 1. 数据初始化
	dgSDK, _ := BsPaySdk.NewBsPay(true, "./config/config.json")

    // 2.组装请求参数
    dgReq := BsPaySdk.V2LargeamtBindcardUnbindRequest{
        // 请求流水号
    ...
    // 3. 发起API调用
    resp, err := dgSDK.V2LargeamtBindcardUnbindRequest(dgReq)
  	if err != nil {
