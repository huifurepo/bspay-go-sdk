...
type V2MerchantBasicdataEntRequest struct {
    ...
    SettleCardFrontPic string `json:"settle_card_front_pic" structs:"settle_card_front_pic"` // 卡正面对私必填。通过[图片上传接口](https://paas.huifu.com/open/doc/api/#/shgl/shjj/api_shjj_shtpsc)上传材料；文件类型：F13 ；&lt;font color&#x3D;&quot;green&quot;&gt;示例值：57cc7f00-600a-33ab-b614-6221bbf2e530&lt;/font&gt;
